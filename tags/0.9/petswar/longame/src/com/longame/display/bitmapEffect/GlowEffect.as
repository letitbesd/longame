 ...
 ******************************************************************************/
package com.longame.display.bitmapEffect
{
	import flash.display.BitmapData;
	import flash.filters.GlowFilter;
	import flash.geom.Point;
	
	public class GlowEffect extends BitmapEffect
	{
		// --------------------------------------------------------------
		...
		public function GlowEffect(color:uint, alpha:Number=1, blurX:Number=6, blurY:Number=6,  strength:Number=2, quality:int=1)
		{
			this.color = color;
			this.alpha = alpha;
			this.blurX = blurX;
