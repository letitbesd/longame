package com.longame.commands.net {
	...
	public class AbstractLoader extends Command{
		...
		protected function onLoadComplete(event : Event) : void {
			...
			Logger.info(this,"onLoadComplete",this.url+" loaded successfully!");
			complete();
		}
...
//			dispatchEvent( event );
		...
		protected function onLoadError(event : ErrorEvent) : void {
			removeListeners();
			Logger.error(this,"onLoadError",this.url+" loaded error, "+(this._currentRetry+1)+" retry of "+this._retryCount);
