package com.longame.modules.groups.organizers
{
	 ...
	 * */
	public class TileMap extends AbstractGroupOrganizer implements IMap
	{
...
//			if(!ch.includeInLayout) return;
			...
			var offset:Point=SceneManager.getTileOffsetBetween(ch,this.group);
		 ...
		 * child的tile发生了移动
		 * */
		long_internal function moveChild(ch:IDisplayEntity,delta:Point):void
		{
		...
		long_internal function bringToTop(ch:IDisplayEntity):void
		{
			...
			if(!this.group.contains(ch)) return;
