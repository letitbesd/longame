package com.longame.modules.components.fight
{
    ...
    {
		[Link]
		public var damageAnim:IDamageAnim;
		[Link]
		public var missAnim:IMissAnim
		[Link]
		public var healAnim:IHealAnim;
		[Link]
...
//            return maxHealth - _health;
        ...
        public function set health(value:Number):void
        {
            ...
            _health = value;
			if(this.healthBar.actived) this.healthBar.updateHP(_health,this._maxHealth);
            // Handle destruction...
...
//				die.die();	
		...
		{
			if(_owner&&die) _owner.state=die.statesInParent[0];
		}
        /** 
         * 受伤害
        ...
        public function damage(amount:Number, originator:IEntity=null, damageType:String = null):void
        {
			...
			if(this.damageAnim) this.damageAnim.showDamage(amount);
        }
		/** 
		 * 受治疗
		...
		public function heal(amount:Number,originator:IEntity=null,healType:String=null):void
		{
			...
			if(this.healAnim&&this.healAnim.actived) this.healAnim.showHeal(amount);
		}
		/**
		 * 改变生命值
		 * @param amount:     改变值
