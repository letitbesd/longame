...
package  com.longame.utils {
	 ...
	 */ 
	public function getDefinitionNames(target:Object, extended:Boolean = false, linkedOnly:Boolean = false):Array {
		var bytes:ByteArray;
		...
		} else throw new ArgumentError('Error #1001: The specified target is invalid');
