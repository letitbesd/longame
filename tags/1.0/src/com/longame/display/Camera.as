package com.longame.display
{
	...
	public class Camera 
	{
		 ...
		 * */
		public function Camera(target:DisplayObject,lensRect:Rectangle=null,width:Number=-1,height:Number=-1)
		{
...
//		private var restraint:Rectangle;
//		/**
//		 * 设置镜头的上下左右边界
//		 * */
//		public function setRestraintRect(x:int,y:int,width:int,height:int):void
//		{
//			this.restraint=new Rectangle(x,y,width,height);
//		}
