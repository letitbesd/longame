package com.xingcloud.net
{
	...
	public class SFSManager extends EventDispatcher
	{
		...
		public function SFSManager()
		{
			...
			_sfsServer.addEventListener(SFSEvent.CONNECTION, onConnected);
		...
		protected function onConnected(event:SFSEvent):void
		{
			isConnecting=false;
		...
		protected function onResponse(event:SFSEvent):void
		{
			...
			{
				Debug.error("Message " + result.id + " hasn't been registered.", this);
			}
			dispatchEvent(event);
		}
