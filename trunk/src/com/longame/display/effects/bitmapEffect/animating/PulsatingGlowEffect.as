package com.longame.display.effects.bitmapEffect.animating
{
	import flash.display.BitmapData;
	import flash.filters.GlowFilter;
	import flash.geom.Point;
	
	import com.longame.display.effects.bitmapEffect.GlowEffect;
	import com.longame.display.effects.bitmapEffect.BitmapEffect;

	public class PulsatingGlowEffect extends BitmapEffect
	{
		public function PulsatingGlowEffect(fromGlow:GlowEffect, toGlow:GlowEffect)
		{
		...
		// --------------------------------------------------------------
		private var fromGlow:GlowEffect;
		private var toGlow:GlowEffect;
