...
package com.bumpslide.ui 
{
	 ...
	 */
	public class SolidBox extends Component implements IGridItem {
		...
		public function SolidBox(color:Number = 0, width:Number = 64, height:Number = 64, x:Number = 0, y:Number = 0, corner_radius:Number = 0, border_width:Number=-1, border_color:uint=0x000000 ) {
			super();	
			updateDelay = 0;		
			_color = color;		
