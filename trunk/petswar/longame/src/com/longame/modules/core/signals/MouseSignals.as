package com.longame.modules.core.signals
{
	...
	public class MouseSignals
	{
		...
		{
			if(_over==null) _over=new NativeSignal(_target.container,MouseEvent.MOUSE_OVER,MouseEvent);
			return _over;
		}
		/**
		 * 鼠标out响应
		...
		{
			if(_out==null) _out=new NativeSignal(_target.container,MouseEvent.MOUSE_OUT,MouseEvent);
			return _out;
		}
	}
}