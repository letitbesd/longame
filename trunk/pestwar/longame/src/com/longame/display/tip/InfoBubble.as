package com.longame.display.tip
{
	...
	public class InfoBubble extends Sprite {
	  ...
	  /**
	  * @param container:气泡放置的容器，null则放到舞台上
	  * */
		public function InfoBubble(container:DisplayObjectContainer=null):void {
		 ...
		 * */
		public function show(target:DisplayObject,title:String,content:String=null,icon:DisplayObject=null):Boolean {
			this._target=target;
			if(this._container==null) this._container=_target.stage;
		...
		{
			this.x = x + this._offSet+this.offsetX;
			this.y = y - this.height +this.offsetY;
		}
