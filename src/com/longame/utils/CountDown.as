package com.longame.utils
{
	...
	public class CountDown extends EventDispatcher
	{
		...
		private function _updateCount(e:TimerEvent):void {
			...
			var _days:Number = Math.floor(_hours / 24);
			...
			if(this.onUpdate) this.onUpdate.dispatch(new Date(null,null,_days,_hours,_minutes,_seconds));			
		}
	}
}