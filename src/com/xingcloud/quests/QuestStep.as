package com.xingcloud.quests
{
	...
	public class QuestStep
	{
		 ...
		 * */
		xingcloud_internal var _completedCount:uint=0;
		...
		public function get completedCount():int
		{
		...
		public function checkAction(act:Action,data:Object):Boolean
		{
			...
			_completedCount++;
			trace("完成一项: ",_action,_completedCount,"总共需要："+_count);
			return isCompleted;
		}
		/**
