...
package {
    ...
    public class _gP {
        ...
        public static function add(_arg1):void{
            physicalObjects.push(_arg1);
        }
        ...
        private static function runPhysics(_arg1, _arg2:Boolean=false):void{
            var _local3:Number;
            var _local4:Number;
            var _local5:Point;
            var _local6:*;
            ...
            if (!_arg1.held){
                if (_arg1.rota){
                    _arg1.rotation = (_arg1.rotation + 5);
                };
                if (_arg1 == _g.P){
                    ...
                    _g.P.drag = (((_local8 * _local12) * 0.35) * _arg1.airRes);
                    if (_g.P.rotation > 0){
                    ...
                    _local17 = ((_local9 * _local13) * _arg1.yVel);
                    if (_arg1.yVel < 0){
                        _local17 = (_local17 * 1);
                    };
                    if (_g.P.stalling){
                    ...
                    if ((((_arg1.yVel > 0)) && (!(_g.P.stalling)))){
                        _local20 = (((0.85 * _local11) * _local14) * _arg1.yVel);
                    } else {
                        _local20 = 0;
                    };
                    if (!_arg1.groundedNow){
                        _local21 = (((_arg1.mass * 5.5) - _local17) - _g.P.lift);
                        _local22 = (_local20 - _g.P.drag);
                        _local22 = (_local22 + windForceX);
                        _local21 = (_local21 + windForceY);
                        _arg1.xVel = (_arg1.xVel * (1 - jetForce));
                    } else {
                        if (_arg1.bounceMode){
                            _local22 = 0;
                            _local21 = (_arg1.mass * 2);
                            _arg1.xVel = (_arg1.xVel * 0.995);
                            _arg1.rotVel = (_arg1.rotVel + (_arg1.xVel / 20));
                        } else {
                            _local22 = 0;
                            _local21 = 0;
                            _arg1.xVel = (_arg1.xVel * _arg1.groundDrag);
                            _arg1.ay = ground;
                        };
                        if (Math.abs(_arg1.xVel) < 0.5){
                            _arg1.xVel = 0;
                            _g.finish();
                        };
                    };
                    ...
                    _local21 = _arg1.yForce;
                    _local22 = _arg1.xForce;
                };
                _local3 = (_local22 / _arg1.mass);
                _local4 = (_local21 / _arg1.mass);
                _arg1.xVel = (_arg1.xVel + (_local3 / 3));
                _arg1.yVel = (_arg1.yVel + (_local4 / 3));
                if (_arg1 == _g.P){
                    if (_arg1.xVel < 0){
                        _arg1.xVel = 0;
                    };
                };
                _arg1.ax = (_arg1.ax + _arg1.xVel);
                if (_arg1.yVel > 40){
                    _arg1.yVel = 40;
                };
                if (((!((_gD.camLockTo == null))) && ((_arg1 == _g.P)))){
                    _gD.camPoint.x = (_gD.camPoint.x + _arg1.xVel);
                };
                if ((_arg1.ay + _arg1.yVel) > ground){
                    if (_arg1.bounceMode){
                        _arg1.ay = ground;
                        _arg1.yVel = (_arg1.yVel * -0.7);
                        _arg1.xVel = (_arg1.xVel * 0.9);
                    } else {
                        _local23 = 0;
                        _arg1.ay = ground;
                        if ((((_g.P == _arg1)) && (_arg1.thrown))){
                            _arg1.grounded();
                        };
                    };
                } else {
                    _local23 = _arg1.yVel;
                    _arg1.ay = (_arg1.ay + _arg1.yVel);
                    if (((!((_gD.camLockTo == null))) && ((_arg1 == _g.P)))){
                        _gD.camPoint.y = (_gD.camPoint.y + _arg1.yVel);
                    };
                };
                if (!_arg2){
                    _arg1.y = _arg1.ay;
                    if ((((_arg1 == _g.P)) && (_gD.camPointLock))){
                        for (_local24 in physicalDoodads) {
                            physicalDoodads[_local24].ax = (physicalDoodads[_local24].ax + (physicalDoodads[_local24].camFact * _arg1.xVel));
                    ...
                    _arg1.prevGap = (_arg1.ax - _arg1.prevX);
                    _arg1.prevX = _arg1.ax;
                    _arg1.x = ((_arg1.ax - _gD.camPoint.x) + _g.sw2);
                    _arg1.y = ((_arg1.ay - _gD.camPoint.y) + _g.sh2);
                    if (_g.P.xVel == 0){
                    } else {
                        if (_g.P.xVel > 0){
                            if (_arg1.x < -400){
        ...
        public static function removeDoodad(_arg1):void{
            var _local2:*;
            for (_local2 in physicalDoodads) {
                if (physicalDoodads[_local2] == _arg1){
                    physicalDoodads.splice(_local2, 1);
                    _gD.G4.removeChild(_arg1);
                    nowDoodads--;
                };
            };
            for (_local2 in physicalCollect) {
                if (physicalCollect[_local2] == _arg1){
                    physicalCollect.splice(_local2, 1);
                    _gD.UG.removeChild(_arg1);
                    _arg1.endMe();
                    if (nowCollect > 0){
                        nowCollect--;
                    };
